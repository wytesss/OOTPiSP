// =============================================================================
// Файл: Form1.cs — главное окно lab5: CRUD, save/load с плагинами обработки, меню.
// =============================================================================
...
namespace lab5
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeDataBinding()
        {
            ...
            // Загрузка при старте + сообщения плагинов (checksum, timestamp…)
            LoadResult loaded = VehicleBsonSerializer.LoadFromFile(FilePath, _settings);
        ...
        /// <summary>Какие обработки включены в appsettings (галочки в настройках).</summary>
        ...
        {
            VehicleBsonSerializer.SaveToFile(FilePath, _vehicles.ToList(), _settings);
