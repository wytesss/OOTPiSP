// =============================================================================
// Файл: PluginLoader.cs — загрузка DLL: IVehiclePlugin + ISerializationProcessingPlugin.
// Лаб. 5: два вида плагинов регистрируются в разные реестры.
// =============================================================================
...
namespace lab5.Plugins
{
    public static class PluginLoader
    {
        ...
        /// <summary>Загрузка одной DLL из меню «Плагины → Загрузить из файла».</summary>
        ...
        private static void LoadPluginsFromAssembly(Assembly assembly, string sourcePath, List<string> errors)
        {
            ...
            try
            {
                ...
                {
                    // Плагин типа ТС → VehicleTypeRegistry
                    ...
                    // Плагин обработки → SerializationPluginRegistry
            ...
            {
                errors.Add($"No plugin implementations found in '{sourcePath}'.");
            }
        }
